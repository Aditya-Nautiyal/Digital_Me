      ...
      <div className="Container">
        ...
        <div className="BigCard">
          ...
          <div className="AboutBio">
            <ScrollAnimation animateIn="fadeInLeft">
              Hello! My name is <strong>Aditya Nautiyal</strong>. MERN stack
              developer with hands-on experience in designing and implementing
              responsive UI components by implementing react concepts. Looking
              forward to acquiring a challenging career with a company to work
              in tandem with a team where I could improve my knowledge and my
              capabilities would be put to use for the development of the
              organization.
            </ScrollAnimation>
